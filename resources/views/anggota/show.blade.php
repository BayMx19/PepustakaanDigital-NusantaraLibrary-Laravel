                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form class="forms-sample">
                        ...
                        <div class="form-group{{ $errors->has('kta') ? ' has-error' : '' }}">
                            <label for="kta" class="col-md-4 control-label">KTA</label>
                            <div class="col-md-6">
                                <input id="kta" type="number" class="form-control" name="kta" value="{{ $data->kta }}" maxlength="8" readonly>
                                @if ($errors->has('kta'))
                                    <span class="help-block">
